...
LIBS="-lkernel" "../${name}-${version}/configure" --host=x86_64-kiwi --prefix=/system --datadir=/system/data/nano --libexecdir=/system/lib --disable-mouse --disable-speller --disable-nls --disable-utf8 ac_cv_header_langinfo_h=0
make -j8
